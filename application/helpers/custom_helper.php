...
if (!function_exists('upload_file')) {
    function upload_file($name, $path, $encryptName = true, $allowed_types = 'gif|jpg|png|jpeg|doc|docx|pdf|xls|xlsx', $maxSize = 90)
    {
        $CI = &get_instance();
...
if (!function_exists('upload_certif')) {
    function upload_certif($name, $path, $encryptName = true, $allowed_types = 'gif|jpg|png|jpeg|doc|docx|pdf|xls|xlsx', $maxSize = 5)
    {
        $CI = &get_instance();
        $CI->load->library('upload');
        if (!file_exists($path)) {
