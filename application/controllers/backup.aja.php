...
class Course extends CI_Controller {
  ...
  public function course_play($id)
  {
      ...
      $config['total_rows'] = $this->db->where(['deleted_at' => NULL, 'id_course' => $id_course])->from("1_course_file")->count_all_results();//total row
    ...
    $data = array(
        ...
        'course' => $this->Course_model->play_course($id_course, $config["per_page"], $data['page']),
